...
<body style="background-color: #686767">
    <div id="app">
        <nav class="navbar navbar-expand-lg fixed-top p-4 shadow p-3 mb-5 bg-body-tertiary rounded">
            <div class="container-fluid">
                <a class="navbar-brand fw-bold" style="color : #8e8e8e" href="{{ route('home') }}">PB <span
                        style="color : #000000">WL</span></a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                    <ul class="navbar-nav fw-semibold">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="color : #0f0e17" href="{{ route('about.index') }}">About</a>
                        </li>
